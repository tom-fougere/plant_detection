...
def test_add_one_image():
    ...
    assert vertical_image.nb_columns == 0
    assert horizontal_image.nb_lines == 0
...
def test_add_several_images():
    ...
    assert full_image.nb_columns == 0
...
def test_add_MergedImage():
    ...
    first_merged_image.add_MergedImage(second_merged_image, axis=0)
